...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Apresentadora virtual feminina para campanhas publicitárias. Modelo realista com sincronização labial perfeita, ideal para divulgação de produtos, serviços e conteúdo educacional em redes sociais.',
    category: 'avatar',
  ...
  },
  {
    ...
    subtitle: 'Avatar Virtual | Vídeo Publicitário',
    description: 'Apresentador virtual masculino para campanhas de marketing digital. Avatar profissional com movimentos naturais e apresentação convincente para anúncios e vídeos promocionais.',
    category: 'avatar',
  ...
  },
  {
    ...
    subtitle: 'Avatar Virtual | Vídeo Publicitário',
    description: 'Porta-voz virtual para marketing digital. Modelo feminina com expressões faciais naturais e apresentação profissional, perfeita para Instagram Reels, TikTok e YouTube Shorts.',
    category: 'avatar',
    tags: ['IA Generativa', 'Avatar Virtual', 'Vídeo Publicitário', 'Modelo Feminino'],
  ...
  },
  {
    ...
    subtitle: 'Avatar Virtual | Vídeo Publicitário',
    description: 'Apresentador virtual para conteúdo educacional e institucional. Avatar masculino com presença profissional, ideal para cursos online, tutoriais e apresentações corporativas.',
    category: 'avatar',
    tags: ['IA Generativa', 'Avatar Virtual', 'Vídeo Publicitário', 'Modelo Masculino'],
  ...
  },
  {
    ...
    subtitle: 'Avatar Virtual | Vídeo Publicitário',
    description: 'Avatar realista para divulgação de produtos e serviços. Modelo virtual feminina com sincronização labial premium e movimentos naturais para campanhas de alto impacto.',
    category: 'avatar',
    tags: ['IA Generativa', 'Avatar Virtual', 'Vídeo Publicitário', 'Modelo Feminino'],
